...
@app.route("/similarity/start", methods=["POST"])
def start_similarity():
    """
    Start a new similarity detection task

    Accepts the following POST parameters:
    - dataset_url [required]: the URL of the zipped dataset to be used
    - similarity_id [optional]: a unique identifier for this similarity task
